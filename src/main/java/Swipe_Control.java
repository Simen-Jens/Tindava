...
public class Swipe_Control extends Auto_Swipe{
    ...
    public IMessage postRecom() throws Exception{
        return cmd.client.getChannelByID(cmd.settings.defaultChannels.split(" ")[1]).sendMessage("", wipeTemplate("Test", "En kul bio", 22, "http://images.gotinder.com/55681cef25c9a285308f5f2f/640x640_beb48a9b-4f92-4505-9f63-a99fb2e23487.jpg"), false);
    }
